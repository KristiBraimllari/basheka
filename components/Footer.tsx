        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-apple-gray-500 text-sm leading-relaxed mb-6">
              Transforming steel into structures with precision, craftsmanship, and innovation.
            </p>
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <Phone size={16} className="text-apple-gray-400 mt-0.5 flex-shrink-0" />
                <span className="text-apple-gray-500 text-sm">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-start space-x-3">
                <Mail size={16} className="text-apple-gray-400 mt-0.5 flex-shrink-0" />
                <span className="text-apple-gray-500 text-sm">info@steelworks.com</span>
              </div>
              <div className="flex items-start space-x-3">
        ...
        <div className="border-t border-apple-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-apple-gray-400 text-sm">
              © {currentYear} SteelWorks. All rights reserved.
            </p>
            <p className="text-apple-gray-400 text-sm">
